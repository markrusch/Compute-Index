...
# EU-CRI Methodology — v0.3.0-dev

EU-CRI (EU Compute Reference Index) is a daily reference price for renting AI compute
delivered from data centres physically located in the EU/EEA. Headline series:
**EU-CRI-H100**, in USD per GPU-hour with a EUR companion at the ECB reference rate.

> **EU-CRI is a price-transparency benchmark, not a settlement benchmark.** Every print is
